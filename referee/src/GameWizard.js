        ...
        <Box flexGrow={1}>
          <Grid alignContent={"flex-end"} className={classes.container}>
            <QueryRenderer
              ...
              render={({ error, props }) => {
                if (error) {
                  return <div>Unable to Load ERROR: {error}</div>;
                }
                if (!props) {
      ...
      render={({ error, props }) => {
        ...
        return (
          <>
            ...
            />
            Waiting on {total - count} out of {total} reports - Please bring
            your Gun to the Sensor
            <Table size="small">
              <TableHead>
                <TableRow>
                  <TableCell></TableCell>
              ...
              <TableCell>
                <Avatar
                  src={
                    ...
                    playerMap[item.playerId].avatarUrl
                  }
                />
              </TableCell>
              <TableCell>
...
const GameWizardContent = (props) => {
  switch (props.activeStep) {
    ...
    case 1:
      return <GameSetup game={props.activeGame} />;
    case 2:
      return <GameRegistration game={props.activeGame} />;
    case 3:
      return <GameRunning game={props.activeGame} />;
    case 4:
      return <GameScoring game={props.activeGame} />;
    case 5:
      return <GameScoreBoard game={props.activeGame} />;
  }
  ...
  return (
    <QueryRenderer
      ...
      render={({ error, props }) => {
        ...
        const activeGame =
          props.active_games_list.length > 0
            ? props.active_games_list[0]
            : null;
        let activeStep = 0;
