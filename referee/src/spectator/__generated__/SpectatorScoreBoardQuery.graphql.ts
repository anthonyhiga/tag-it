...
export type SpectatorScoreBoardQueryVariables = {
    id: string;
};
export type SpectatorScoreBoardQueryResponse = {
...
export type SpectatorScoreBoardQuery = {
    readonly response: SpectatorScoreBoardQueryResponse;
    readonly variables: SpectatorScoreBoardQueryVariables;
};



/*
query SpectatorScoreBoardQuery(
  $id: ID!
) {
  game_score(id: $id) {
    id
...
return {
  ...
  "params": {
    "cacheID": "c535fa5c06dbd66d6d658b5b4a762a15",
    "id": null,
    "metadata": {},
    "name": "SpectatorScoreBoardQuery",
    "operationKind": "query",
    "text": "query SpectatorScoreBoardQuery(\n  $id: ID!\n) {\n  game_score(id: $id) {\n    id\n    gameId\n    teamId\n    playerId\n    totalTagsReceived\n    totalTagsGiven\n    survivedTimeSec\n    zoneTimeSec\n    ltGameId\n    ltTeamId\n    ltPlayerId\n  }\n  game_players_list(id: $id) {\n    id\n    items {\n      id\n      status\n      ltTeamId\n      ltPlayerId\n      name\n      totemId\n      avatarUrl\n      iconUrl\n    }\n  }\n  game_settings(id: $id) {\n    countDownSec\n    gameLengthInMin\n    health\n    reloads\n    shields\n    megatags\n    totalTeams\n    id\n  }\n}\n"
  }
};
})();
(node as any).hash = '065724f1279c4231fe10a9f8d85656ce';
export default node;
